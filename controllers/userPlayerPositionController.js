...
export const createUserPlayerPosition = async (req, res) => {
  try {
    ...
    const position = await UserPlayerPosition.createUserPlayerPosition({
      userId,
      playerId,
      teamId,
      playing11Position,
...
export const updateUserPlayerPosition = async (req, res) => {
  try {
    const { userId, playerId, teamId, playing11Position } = req.body;
    const position = await UserPlayerPosition.updateUserPlayerPosition(
      userId,
      playerId,
      teamId,
      playing11Position
...
export const bulkUpdateUserPlayerPositions = async (req, res) => {
  ...
  try {
    const result = await UserPlayerPosition.bulkUpdateUserPlayerPositions(
      userId,
      teamId,
      players
    );
...
export const deleteUserPlayerPosition = async (req, res) => {
  try {
    ...
    const position = await UserPlayerPosition.deleteUserPlayerPosition(
      userId,
      playerId,
      teamId
    );
